                ...
                <div className="py-2.5 px-6 border-4 border-primary shadow-md contact-form">
                    ...
                    <div className="flex flex-col md:flex-row justify-between">
                        ...
                        <div className="mt-5 md:mt-28 mb-10 md:mb-0 flex md:block justify-center">
                            <a className=" py-2 px-4 border-2 border-primary bg-primary text-white font-montserrat text-base md:text-xl items-center hover:bg-white hover:text-primary transition-all" href="#">Send message</a>
                        </div>
                    </div>
                </div>
            </div>
